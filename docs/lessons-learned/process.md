...
3. Create a business model that can quantifies expected, conservative and aggressive projections
...
---
## Step 2: Identify implementation limitations early on
...
During the **build** and **launch** phase, we should always plan balance in our sprints and release milestones to prevent technical and operational debt from compounding into an insurmountible issue in the future.

1. For any release (major, minor, patch), we should always have a go/no-go checklist that includes tests, security reviews and configurations that need to be deployed
...
3. My guidelines: I expect only 25% of the work completed in a sprint will be actual design and development. This is due to the fact that a good engineering manager will always estimate ~2x the effort to deliver a feature. On top of that, my estimate for each sprint is 50% for the feature, 25% for usability bug bashes and simulated user journey testing, and 25% for support, tech debt and process improvements.
